...
\caption{Shows the age, gender, country of residence, and education status, and primary
language of participants by trial arm and list experiment ($N =
\Sexpr{fmt(flow$FinalN)}$).}

\label{tab:tab1}
\footnotesize
\begin{tabular}{l *{12}{C{0.8cm}}}
  \toprule
  & \multicolumn{4}{c}{\textbf{Do-nothing}} &
  \multicolumn{4}{c}{\textbf{APC}}  &
  \multicolumn{4}{c}{\textbf{E-E video}} \\ 
